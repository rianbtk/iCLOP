         ...
         <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                  ...
                  @if ($valid=='0')
                   <a class="btn btn-success" href="{{ URL::to('/student/nodejscourse/results/create/'.$filter)}}"><i class="fa fa-plus"></i>&nbsp;Submit a Task Result</a>
                   @endif
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <form method="POST" action="{{ URL::to('/student/nodejscourse/results/'.$entity['id']) }}">
                                        {{ csrf_field() }}
                                        <input type="hidden" name="_method" value="DELETE" />
                                        <input type="hidden" name="topic" value="{{ $filter }}" />
                                        <div class="btn-group">
                                            <a class="btn btn-success" href="{{ URL::to('/student/nodejscourse/results/'.$entity['id'].'/edit') }}"><i class="fa fa-pencil-alt"></i></a>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <form method="POST" action="{{ URL::to('/student/lfiles/'.$lfile['id']) }}">
                                        ...
                                        <input type="hidden" name="topic" value="{{ $filter }}" />
                                        <div class="btn-group">
                                            <!--<a class="btn btn-info" href="{{ URL::to('/student/nodejscourse/results/'.$entity['id']) }}"><i class="fa fa-eye"></i></a>
                                            -->
